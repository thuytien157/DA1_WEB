                    ...
                    <section>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                <a style="color: black;" href="sanphamtheodanhmuc.html"><label class="form-check-label" for="newProductsCheckbox">Sản Phẩm Mới</label></a>
                            </li>
                            <li class="list-group-item">
                                <label class="form-check-label" for="bestsellersCheckbox">Sản Phẩm Bán Chạy</label>
                            </li>
                            <li class="list-group-item">
                                <label class="form-check-label" for="discountsCheckbox">Sản Phẩm Khuyến Mãi & Ưu Đãi</label>
                            </li>
                        </ul>
                    </section>
                </div>
