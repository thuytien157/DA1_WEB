            ...
            <div class="row">
              <div class="col">
                <div class="box-category">
                    <div class="title-category">DOREAMON</div>
                    <img class="img-category" src="public/img/IMG_DA1/danh muc/dm-doraemon.jpg" alt="">
                    <button class="button-category">KHÁM PHÁ</button>
                </div>
              ...
              <div class="col">
                <div class="box-category">
                    <div class="title-category">DOREAMON</div>
                    <img class="img-category" src="public/img/IMG_DA1/danh muc/dm-conan.png" alt="">
                    <button class="button-category">KHÁM PHÁ</button>
                </div>
              ...
              <div class="col">
                <div class="box-category">
                    <div class="title-category">DOREAMON</div>
                    <img class="img-category" src="public/img/IMG_DA1/danh muc/dm-jjk.jpg" alt="">
                    <button class="button-category">KHÁM PHÁ</button>
                </div>
              </div>
            </div>
