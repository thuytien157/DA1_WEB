                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item dropdown ms-3">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="accountDropdown">
                                ...
                                ?>
                                <?php
                                if (isset($_SESSION['user']['username']) && ($_SESSION['vai_tro'] == 1 || $_SESSION['vai_tro'] == 2)) {
                                    echo '<li><a class="dropdown-item" href="index.php?act=readmin">Đến Admin</a></li>';
                                }
                                ?>
                                <li><a class="dropdown-item" href="index.php?act=<?php echo isset($_SESSION['user']['username']) ? 'logout' : 'login'; ?>">
                                        <?php echo isset($_SESSION['user']['username']) ? "Đăng Xuất" : "Đăng Nhập"; ?>
                                    </a></li>
                            </ul>
